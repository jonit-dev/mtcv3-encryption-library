...
exports.INVERSE_MIXING_MATRIX = exports.MIXING_MATRIX = void 0;
// Define the mixing matrix
exports.MIXING_MATRIX = [
    [2, 3, 1, 1],
    [1, 2, 3, 1],
    [1, 1, 2, 3],
    [3, 1, 1, 2],
];
exports.INVERSE_MIXING_MATRIX = matrixInverseMod256(exports.MIXING_MATRIX);
// Function to compute the inverse of a 4x4 matrix modulo 256
function matrixInverseMod256(matrix) {
    ...
    const inverse = adjugate.map((row) => row.map((value) => (((value * detInv) % 256) + 256) % 256));
    return inverse;
}
...
try {
    const correctInverse = matrixInverseMod256(exports.MIXING_MATRIX);
